...
const presentationCss = fs.readFileSync(new URL('../src/styles/singlePlayerV2/components/utilityButtons.css', import.meta.url), 'utf8');
...
assert.match(presentationCss, /^@layer spv2\.components \{/);
assert.doesNotMatch(presentationCss, /@import\s+url\(/);
...
assert.match(presentationCss, /presentation-cue-card-place/);
assert.match(presentationCss, /presentation-cue-pattern/);
assert.match(presentationCss, /presentation-cue-threshold-clear/);
