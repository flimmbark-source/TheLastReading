...
const patchedRefreshBlock = previousRefreshBlock;
...
.spread .slot.ability-target-slot .card{pointer-events:auto}
...
if (changed) {
  ...
  console.log('Patched spread ability targeting and highlight styling.');
} else {
