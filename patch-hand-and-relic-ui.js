...
upsertBlock(
  ...
  // Observer + resize events can fire many times per frame during animations
  // (card deal, hand re-render). Coalesce to one rAF.
  ...
  const attachObserver=()=>{
    ...
    new MutationObserver(scheduleRecheck).observe(h,{childList:true});
    refreshLayout();
