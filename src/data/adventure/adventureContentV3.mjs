...
export const OUTCOME_REWARDS = Object.freeze({
  ...
  'beneath_the_floor:seal':        Object.freeze({ reinforce: add(N.PROTECTION, N.CREATION),      provision: consume('iron_ward'),           crossroads: upgrade(N.PROTECTION, N.CREATION),      signature: signature('warded_iron_nails') }),
