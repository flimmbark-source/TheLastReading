...
export const OUTCOME_REWARDS = Object.freeze({
  ...
  'ambush:fight':                  Object.freeze({ reinforce: add(N.AGGRESSION),                  provision: consume('whetstone'),           crossroads: banishTwo,                             signature: signature('notched_blade') }),
  ...
  'flooded_road:ford':             Object.freeze({ reinforce: add(N.PHYSICAL),                    provision: consume('whetstone'),           crossroads: banishTwo,                             signature: signature('ferrymans_boots') }),
  ...
  'cornered_beast:brace':          Object.freeze({ reinforce: add(N.PROTECTION),                  provision: consume('iron_ward'),           crossroads: banishTwo,                             signature: signature('hide_mantle') }),
