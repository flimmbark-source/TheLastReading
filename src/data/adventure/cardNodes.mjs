...
export const CARD_ACTION_NODES = Object.freeze({
  ...
  major_2: ACTION_NODES.DECEPTION,
  major_3: ACTION_NODES.COMPASSION,
  ...
  major_16: ACTION_NODES.TRANSFORMATION,
  major_17: ACTION_NODES.PROTECTION,
  major_18: ACTION_NODES.DECEPTION,
  major_19: ACTION_NODES.FORTUNE,
  ...
  court_Swords_King: ACTION_NODES.AGGRESSION,

  court_Pentacles_Page: ACTION_NODES.ENDURANCE,
  court_Pentacles_Knight: ACTION_NODES.ENDURANCE,
  court_Pentacles_Queen: ACTION_NODES.PROTECTION,
  court_Pentacles_King: ACTION_NODES.ENDURANCE,
});
