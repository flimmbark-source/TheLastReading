...
export const MAJOR_ARCANA = [
  { number: 0,  name: 'Fool',          points: 5, trull: true,  ability: 'PEEK_3',    suits: ['Wands'] },
  { number: 1,  name: 'Magician',      points: 5, trull: true,  ability: 'SEARCH',    suits: ['Wands', 'Cups', 'Swords', 'Pentacles'] },
  { number: 2,  name: 'High Priestess',points: 1, trull: false, ability: 'NEIGHBOR_2',suits: ['Cups'] },
  { number: 3,  name: 'Empress',       points: 1, trull: false, ability: 'DRAW_2',    suits: ['Wands', 'Pentacles'] },
  { number: 4,  name: 'Emperor',       points: 1, trull: false, ability: 'DRAW_1',    suits: ['Wands', 'Pentacles'] },
  { number: 5,  name: 'Hierophant',    points: 1, trull: false, ability: 'BETWEEN_2', suits: ['Wands'] },
  ...
  { number: 9,  name: 'Hermit',        points: 1, trull: false, ability: 'NEIGHBOR_2',suits: ['Wands'] },
  { number: 10, name: 'Wheel',         points: 1, trull: false, ability: 'MIRROR_1' },
  { number: 11, name: 'Justice',       points: 1, trull: false, ability: 'KIN_2',     suits: ['Swords', 'Pentacles'] },
  { number: 12, name: 'Hanged Man',    points: 1, trull: false, ability: 'BETWEEN_2' },
  { number: 13, name: 'Death',         points: 1, trull: false, ability: 'DRAW_3' },
  { number: 14, name: 'Temperance',    points: 1, trull: false, ability: 'BETWEEN_2', suits: ['Cups'] },
  { number: 15, name: 'Devil',         points: 1, trull: false, ability: 'DRAW_2' },
  { number: 16, name: 'Tower',         points: 1, trull: false, ability: 'DRAW_2',    suits: ['Wands', 'Swords'] },
  { number: 17, name: 'Star',          points: 1, trull: false, ability: 'KIN_2',     suits: ['Cups'] },
  { number: 18, name: 'Moon',          points: 1, trull: false, ability: 'MIRROR_1',  suits: ['Cups'] },
  { number: 19, name: 'Sun',           points: 1, trull: false, ability: 'DRAW_2',    suits: ['Wands'] },
  { number: 20, name: 'Judgement',     points: 1, trull: false, ability: 'MIRROR_1' },
  { number: 21, name: 'World',         points: 5, trull: true,  ability: 'WORLD',     suits: ['Wands', 'Pentacles'] },
].map(card => ({
  ...card,
