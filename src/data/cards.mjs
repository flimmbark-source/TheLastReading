...
export const MAJOR_ARCANA = [
  { number: 0, name: 'Fool', points: 5, trull: true, ability: 'PEEK_3' },
  { number: 1, name: 'Magician', points: 5, trull: true, ability: 'SEARCH' },
  { number: 2, name: 'High Priestess', points: 1, trull: false, ability: 'NEIGHBOR_2' },
  { number: 3, name: 'Empress', points: 1, trull: false, ability: 'DRAW_2' },
  { number: 4, name: 'Emperor', points: 1, trull: false, ability: 'DRAW_1' },
  { number: 5, name: 'Hierophant', points: 1, trull: false, ability: 'BETWEEN_2' },
  ...
  { number: 9, name: 'Hermit', points: 1, trull: false, ability: 'NEIGHBOR_2' },
  { number: 10, name: 'Wheel', points: 1, trull: false, ability: 'MIRROR_1' },
  { number: 11, name: 'Justice', points: 1, trull: false, ability: 'KIN_2' },
  { number: 12, name: 'Hanged Man', points: 1, trull: false, ability: 'BETWEEN_2' },
  { number: 13, name: 'Death', points: 1, trull: false, ability: 'DRAW_3' },
  { number: 14, name: 'Temperance', points: 1, trull: false, ability: 'BETWEEN_2' },
  { number: 15, name: 'Devil', points: 1, trull: false, ability: 'DRAW_2' },
  { number: 16, name: 'Tower', points: 1, trull: false, ability: 'DRAW_2' },
  { number: 17, name: 'Star', points: 1, trull: false, ability: 'KIN_2' },
  { number: 18, name: 'Moon', points: 1, trull: false, ability: 'MIRROR_1' },
  { number: 19, name: 'Sun', points: 1, trull: false, ability: 'DRAW_2' },
  { number: 20, name: 'Judgement', points: 1, trull: false, ability: 'MIRROR_1' },
  { number: 21, name: 'World', points: 5, trull: true, ability: 'WORLD' },
].map(card => ({
  ...card,
