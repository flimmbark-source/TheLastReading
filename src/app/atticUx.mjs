...
/* The live WebGL canvas is reparented to #table3dSeat during the return. Once
   it leaves #atticScene, that element contains only the classic painted attic;
   keep that legacy layer suppressed so it cannot replace the reverse sit. */
html body.table3d-continuous-return.mode-attic #atticScene,html body.table3d-continuous-return.mode-to-table #atticScene,html body.table3d-continuous-return.mode-table-return #atticScene,html body.table3d-continuous-return.mode-return-hard-hide #atticScene{opacity:0!important;pointer-events:none!important;transition:none!important}
html body.table3d-continuous-return #atticPan{display:none!important}
