...
//   rules    — templated rules text using semantic game-term markup
//   reminder — optional muted line explaining a referenced rule
//   flavor   — optional one-line italic flavor quote
//
// Rules text style guide: lead with the timing window, state the effect in
// the fewest words that stay unambiguous, capitalize game terms, use digits
// for numbers, and never expose the internal word "invoke".
...
export const PERSONAS = Object.freeze({
  ...
  cleaner: {
    id: 'cleaner',
    name: 'The Cleaner',
    tagline: 'Start with 3 Banish cards in your Deck.',
    ...
    ability: {
      name: 'Cleansing Rite',
      tag: 'Game Start',
      rules: 'Your [[deck]] starts with 3 [[banish|Banish cards]].',
      reminder: 'Banish removes the last card your opponent Played.',
  ...
  hoarder: {
    ...
    ability: {
      name: 'Overdraw',
      tag: 'Passive',
      rules: '+1 [[hand|Hand Size]]. −1 starting [[discard]].',
  ...
  anchor: {
    id: 'anchor',
    name: 'The Anchor',
    tagline: 'Your first Played card each round is protected.',
    ...
    ability: {
      name: 'Significator',
      tag: 'Passive',
      rules: 'The first card you [[play]] each round can’t be removed or silenced.',
  ...
  gambit: {
    id: 'gambit',
    name: 'The Gambit',
    tagline: 'Once per round: Discard a card, then Draw its Value.',
    ...
    ability: {
      ...
      reminder: 'Value is the number shown on the card.',
  ...
  surgeon: {
    id: 'surgeon',
    name: 'The Surgeon',
    tagline: 'Once per round: swap a card between your Spread and Hand.',
    ...
    ability: {
      name: 'Transposition',
      tag: 'Once per Round',
      rules: 'On your turn, swap 1 card in your [[spread]] with 1 card in your [[hand]] for free.',
