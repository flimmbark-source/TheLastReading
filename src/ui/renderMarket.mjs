...
function ensureStoreFrontStyles(target = window) {
  ...
  style.textContent = `
    ...
    .store-section{position:absolute;left:5.3%;right:5.3%}.store-section.scoring{top:16.1%;height:21.7%}.store-section.abilities{top:39.6%;height:22.6%}.store-section.relics{top:65.7%;height:20.5%}
    .store-plaque{position:absolute;left:50%;top:0;width:39%;height:11.5%;transform:translate(-50%,-36%);background:url('${STORE_ASSET_PATH}Section_Plaque.png') center/100% 100% no-repeat;display:flex;align-items:center;justify-content:center;gap:.35em;text-align:center;text-transform:uppercase;letter-spacing:.07em;font-size:16px;font-weight:800;color:#d6b16f;text-shadow:0 2px 3px #000;pointer-events:none}.store-plaque .store-section-icon{font-size:.68em;opacity:.9}.store-section-copy{position:absolute;left:4%;right:4%;top:9%;text-align:center;font:600 11px system-ui,Segoe UI,sans-serif;color:#dfcda8;text-shadow:0 1px 2px #000;pointer-events:none}.store-offer-row{position:absolute;left:17.2%;right:8.5%;top:28%;bottom:12%;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9.5%}.store-relic-row{position:absolute;left:15.3%;right:5.2%;top:24%;bottom:11%;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:5.5%}
    ...
    .store-relic-offer{display:flex;flex-direction:column;align-items:center;justify-content:flex-end;padding:0 2% 2.5%;text-align:center}.store-relic-art{position:absolute;top:0;left:50%;width:62px;height:62px;transform:translateX(-50%);display:flex;align-items:center;justify-content:center;pointer-events:none}.store-relic-art .relic-art-sprite{width:62px;height:62px;flex:0 0 62px;filter:drop-shadow(0 5px 5px rgba(0,0,0,.65))}.store-vessel-glyph{font:800 28px/1 Georgia,serif;color:#f1d196;text-shadow:0 2px 5px #000}.store-relic-name{width:100%;font-size:8.5px;line-height:1.02;text-transform:uppercase;font-weight:800;color:#f0dfbd;text-shadow:0 1px 3px #000}.store-relic-desc{display:none}.store-relic-buy{position:relative;left:auto;right:auto;bottom:auto;width:84%;height:auto;min-height:18%;margin-top:.36em;padding:.28em .12em}.store-relic-offer.disabled .store-relic-buy{pointer-events:none}
    ...
    @media(min-width:900px){.store-front{width:min(52vw,calc(96dvh * .6667),760px)}.store-title{font-size:27px}.store-title small{font-size:11px}.store-subtitle{font-size:12px}.store-plaque{font-size:15px}.store-section-copy{font-size:10px}.store-pack-name{font-size:11.5px}.store-pack-desc{font-size:8.5px}.store-pack-buy,.store-relic-buy{font-size:8.8px}.store-pack-art .isp{transform:scale(.78)}.store-relic-name{font-size:8.2px}.store-relic-art,.store-relic-art .relic-art-sprite{width:58px;height:58px;flex-basis:58px}.store-vessel-glyph{font-size:25px}}
    @media(max-width:640px){.modal:has(.store-front-shell){padding:4px}.store-front{width:min(98vw,calc(96dvh * .6667));}.store-title{top:3.75%;font-size:21px}.store-title small{font-size:8px}.store-subtitle{top:10.7%;font-size:8.5px}.store-reserve{right:5.9%;top:3.5%;width:15.8%;height:7%}.store-reserve-label{font-size:6px}.store-reserve-value{font-size:18px}.store-section.scoring{top:16%;height:21.8%}.store-section.abilities{top:39.7%;height:22.7%}.store-section.relics{top:65.9%;height:20%}.store-plaque{font-size:11px;width:42%;height:11.5%}.store-section-copy{top:9.5%;font-size:7.8px}.store-offer-row{left:17%;right:8.5%;top:29%;bottom:13%;gap:7%}.store-relic-row{left:14%;right:4.5%;top:25.5%;bottom:10%;gap:3.8%}.store-pack-art{left:-1%;width:40%}.store-pack-art .isp{transform:scale(.58)}.store-pack-body{left:42%;right:1%;bottom:34%}.store-pack-name{font-size:8px}.store-pack-desc{font-size:6.2px}.store-pack-buy,.store-relic-buy{font-size:6.4px;border-radius:4px}.store-relic-art,.store-relic-art .relic-art-sprite{width:38px;height:38px;flex-basis:38px}.store-vessel-glyph{font-size:20px}.store-relic-name{font-size:5.9px}.store-relic-buy{width:88%;padding:.2em .1em}.store-actions{bottom:2.55%;height:7%}.store-refresh{font-size:7.5px}.store-proceed{font-size:11px}}
  `;
