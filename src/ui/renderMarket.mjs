...
function ensureStoreFrontStyles(target = window) {
  ...
  style.textContent = `
    ...
    .store-section{position:absolute;left:5.3%;right:5.3%}.store-section.scoring{top:16.1%;height:21.7%}.store-section.abilities{top:41.9%;height:21.7%}.store-section.relics{top:67.2%;height:19.1%}
    .store-plaque{position:absolute;left:50%;top:0;width:39%;height:11.5%;transform:translate(-50%,-36%);background:url('${STORE_ASSET_PATH}Section_Plaque.png') center/100% 100% no-repeat;display:flex;align-items:center;justify-content:center;gap:.35em;text-align:center;text-transform:uppercase;letter-spacing:.07em;font-size:16px;font-weight:800;color:#d6b16f;text-shadow:0 2px 3px #000;pointer-events:none}.store-plaque .store-section-icon{font-size:.68em;opacity:.9}.store-section-copy{position:absolute;left:4%;right:4%;top:9%;text-align:center;font:600 11px system-ui,Segoe UI,sans-serif;color:#dfcda8;text-shadow:0 1px 2px #000;pointer-events:none}.store-offer-row{position:absolute;left:20.5%;right:10%;top:29%;bottom:13%;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:11%}.store-relic-row{position:absolute;left:14.2%;right:4.5%;top:31%;bottom:10%;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:5%}
    ...
    .store-pack-art{position:absolute;left:4%;top:10%;bottom:14%;width:31%;display:flex;align-items:center;justify-content:center;pointer-events:none}.store-pack-art .isp{transform:scale(.48);transform-origin:center;filter:drop-shadow(0 4px 5px rgba(0,0,0,.65))}.store-pack-body{position:absolute;left:40%;right:3%;top:11%;bottom:33%;display:flex;flex-direction:column;justify-content:center;text-align:left;pointer-events:none}.store-pack-name{font-size:12px;line-height:1.02;text-transform:uppercase;font-weight:800;color:#f0dfbd;text-shadow:0 1px 3px #000}.store-pack-desc{margin-top:.32em;font:600 9px system-ui,Segoe UI,sans-serif;color:#d5c6a8;line-height:1.12}.store-pack-buy,.store-relic-buy{position:absolute;right:4%;bottom:5%;min-width:40%;height:20%;border:1px solid rgba(226,181,100,.7);border-radius:5px;background:rgba(8,8,10,.52);color:#f5d9a0;text-transform:uppercase;letter-spacing:.05em;font-weight:800;font-size:9.5px;box-shadow:inset 0 0 10px rgba(0,0,0,.42),0 1px 3px rgba(0,0,0,.36)}.store-pack-buy .coin,.store-relic-buy .coin{color:#c99443;margin-left:.2em}
    .store-relic-offer{display:flex;flex-direction:column;align-items:center;justify-content:flex-end;padding:0 3% 2.5%;text-align:center}.store-relic-art{position:absolute;top:1%;left:50%;width:54px;height:54px;transform:translateX(-50%);display:flex;align-items:center;justify-content:center;pointer-events:none}.store-relic-art .relic-art-sprite{width:54px;height:54px;flex:0 0 54px;filter:drop-shadow(0 5px 5px rgba(0,0,0,.65))}.store-vessel-glyph{font:800 25px/1 Georgia,serif;color:#f1d196;text-shadow:0 2px 5px #000}.store-relic-name{width:100%;font-size:9px;line-height:1.02;text-transform:uppercase;font-weight:800;color:#f0dfbd;text-shadow:0 1px 3px #000}.store-relic-desc{min-height:2.5em;margin-top:.18em;font:600 7.5px system-ui,Segoe UI,sans-serif;color:#dfd2ba;line-height:1.08}.store-relic-buy{position:relative;left:auto;right:auto;bottom:auto;width:86%;height:auto;min-height:18%;margin-top:.38em;padding:.28em .12em}.store-relic-offer.disabled .store-relic-buy{pointer-events:none}
    ...
    @media(min-width:900px){.store-front{width:min(46vw,calc(94dvh * .6667),640px)}.store-title{font-size:27px}.store-title small{font-size:11px}.store-subtitle{font-size:12px}.store-plaque{font-size:15px}.store-section-copy{font-size:10px}.store-pack-name{font-size:11px}.store-pack-desc{font-size:8.5px}.store-pack-buy,.store-relic-buy{font-size:8.8px}.store-relic-name{font-size:8.2px}.store-relic-desc{font-size:7px}.store-relic-art,.store-relic-art .relic-art-sprite{width:50px;height:50px;flex-basis:50px}.store-vessel-glyph{font-size:23px}}
    @media(max-width:640px){.modal:has(.store-front-shell){padding:4px}.store-front{width:min(98vw,calc(96dvh * .6667));}.store-title{top:3.75%;font-size:21px}.store-title small{font-size:8px}.store-subtitle{top:10.7%;font-size:8.5px}.store-reserve{right:5.9%;top:3.5%;width:15.8%;height:7%}.store-reserve-label{font-size:6px}.store-reserve-value{font-size:18px}.store-section.scoring{top:16%;height:21.8%}.store-section.abilities{top:41.85%;height:21.7%}.store-section.relics{top:67.1%;height:19%}.store-plaque{font-size:11px;width:42%;height:11.5%}.store-section-copy{top:9.5%;font-size:7.8px}.store-offer-row{left:19.5%;right:9%;top:29.2%;bottom:13%;gap:8%}.store-relic-row{left:13.7%;right:4%;top:31%;bottom:9.5%;gap:3.6%}.store-pack-art{left:3%;width:33%}.store-pack-art .isp{transform:scale(.42)}.store-pack-body{left:39%;right:2%;bottom:34%}.store-pack-name{font-size:8px}.store-pack-desc{font-size:6.2px}.store-pack-buy,.store-relic-buy{font-size:6.4px;border-radius:4px}.store-relic-art,.store-relic-art .relic-art-sprite{width:36px;height:36px;flex-basis:36px}.store-vessel-glyph{font-size:20px}.store-relic-name{font-size:5.9px}.store-relic-desc{font-size:5.2px}.store-relic-buy{width:88%;padding:.2em .1em}.store-actions{bottom:2.55%;height:7%}.store-refresh{font-size:7.5px}.store-proceed{font-size:11px}}
  `;
