...
const STORE_SCORING_COPY = Object.freeze({
  ...
  suit_stamp: { name: 'Suit Stamp', desc: 'Pick a Major — its suit counts toward Royal Court.', icon: 'isp-scoring' },
  five_stamp: { name: 'Five Star', desc: 'Pick any card — slots into Sequences as a multiple of 5.', icon: 'isp-scoring' },
});
