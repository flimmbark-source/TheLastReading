...
/* The room is scaled by viewport height, so the whole vertical space of the wide attic is always visible. */
...
.attic-prop.sprite-sheet{background-size:200% 100%!important;background-repeat:no-repeat!important}
.attic-prop.sprite-sheet:not(.searched){background-position:0% 50%!important}
.attic-prop.sprite-sheet.searched{background-position:100% 50%!important}
...
// Reposition the three rummage props for the wide attic art and use their uploaded images as 2-frame sprite sheets.
// Left half = default object. Right half = rummaged object.
html = html.replace("newspaper_stack_01:{id:'newspaper_stack_01',label:'Stack of Newspapers',verb:'Move aside',motion:'move',cost:1,before:'props/newspaper_stack_closed.png',after:'props/newspaper_stack_moved.png',left:'7%',top:'67%',width:'42%',height:'22%',itemId:'clipping_01',itemTitle:'Strange Obituary',thumb:'strange_obituary.png'}", "newspaper_stack_01:{id:'newspaper_stack_01',label:'Stack of Newspapers',verb:'Move aside',motion:'move',cost:1,sheet:'props/newspaper_stack_closed.png',before:'props/newspaper_stack_closed.png',after:'props/newspaper_stack_closed.png',left:'14%',top:'71%',width:'25%',height:'20%',itemId:'clipping_01',itemTitle:'Strange Obituary',thumb:'strange_obituary.png'}");
html = html.replace("covered_frame_01:{id:'covered_frame_01',label:'Covered Frame',verb:'Lift cloth',motion:'lift',cost:1,before:'props/covered_frame_closed.png',after:'props/covered_frame_uncovered.png',left:'57%',top:'28%',width:'42%',height:'43%',itemId:'photo_01',itemTitle:'The Reading Room',thumb:'Reading_room.png'}", "covered_frame_01:{id:'covered_frame_01',label:'Covered Frame',verb:'Lift cloth',motion:'lift',cost:1,sheet:'props/covered_frame_closed.png',before:'props/covered_frame_closed.png',after:'props/covered_frame_closed.png',left:'67%',top:'16%',width:'25%',height:'44%',itemId:'photo_01',itemTitle:'The Reading Room',thumb:'Reading_room.png'}");
html = html.replace("coat_01:{id:'coat_01',label:'Old Coat',verb:'Check pocket',motion:'search',cost:1,before:'props/old_coat_closed.png',after:'props/old_coat_searched.png',left:'17%',top:'30%',width:'39%',height:'44%',itemId:'letter_01',itemTitle:'Unsigned Letter',thumb:'handwritten_note.png'}", "coat_01:{id:'coat_01',label:'Old Coat',verb:'Check pocket',motion:'search',cost:1,sheet:'props/old_coat_closed.png',before:'props/old_coat_closed.png',after:'props/old_coat_closed.png',left:'4%',top:'14%',width:'24%',height:'67%',itemId:'letter_01',itemTitle:'Unsigned Letter',thumb:'handwritten_note.png'}");
html = html.replace("newspaper_stack_01:{id:'newspaper_stack_01',label:'Stack of Newspapers',verb:'Move aside',motion:'move',cost:1,before:'props/newspaper_stack_closed.png',after:'props/newspaper_stack_moved.png',left:'14%',top:'71%',width:'25%',height:'20%',itemId:'clipping_01',itemTitle:'Strange Obituary',thumb:'strange_obituary.png'}", "newspaper_stack_01:{id:'newspaper_stack_01',label:'Stack of Newspapers',verb:'Move aside',motion:'move',cost:1,sheet:'props/newspaper_stack_closed.png',before:'props/newspaper_stack_closed.png',after:'props/newspaper_stack_closed.png',left:'14%',top:'71%',width:'25%',height:'20%',itemId:'clipping_01',itemTitle:'Strange Obituary',thumb:'strange_obituary.png'}");
html = html.replace("covered_frame_01:{id:'covered_frame_01',label:'Covered Frame',verb:'Lift cloth',motion:'lift',cost:1,before:'props/covered_frame_closed.png',after:'props/covered_frame_uncovered.png',left:'67%',top:'16%',width:'25%',height:'44%',itemId:'photo_01',itemTitle:'The Reading Room',thumb:'Reading_room.png'}", "covered_frame_01:{id:'covered_frame_01',label:'Covered Frame',verb:'Lift cloth',motion:'lift',cost:1,sheet:'props/covered_frame_closed.png',before:'props/covered_frame_closed.png',after:'props/covered_frame_closed.png',left:'67%',top:'16%',width:'25%',height:'44%',itemId:'photo_01',itemTitle:'The Reading Room',thumb:'Reading_room.png'}");
html = html.replace("coat_01:{id:'coat_01',label:'Old Coat',verb:'Check pocket',motion:'search',cost:1,before:'props/old_coat_closed.png',after:'props/old_coat_searched.png',left:'4%',top:'14%',width:'24%',height:'67%',itemId:'letter_01',itemTitle:'Unsigned Letter',thumb:'handwritten_note.png'}", "coat_01:{id:'coat_01',label:'Old Coat',verb:'Check pocket',motion:'search',cost:1,sheet:'props/old_coat_closed.png',before:'props/old_coat_closed.png',after:'props/old_coat_closed.png',left:'4%',top:'14%',width:'24%',height:'67%',itemId:'letter_01',itemTitle:'Unsigned Letter',thumb:'handwritten_note.png'}");

// Render sprite-sheet objects by shifting background-position instead of swapping image files.
html = html.replace(/el\.className='attic-prop motion-'\+o\.motion\+\(done\?' searched':''\);/g, "el.className='attic-prop motion-'+o.motion+(o.sheet?' sprite-sheet':'')+(done?' searched':'');");
html = html.replace(/el\.style\.backgroundImage='url\("'\+\(done\?o\.after:o\.before\)\+'"\)';/g, "el.style.backgroundImage='url(\"'+(o.sheet||(done?o.after:o.before))+'\")';el.style.backgroundSize=o.sheet?'200% 100%':'contain';el.style.backgroundPosition=o.sheet?(done?'100% 50%':'0% 50%'):'center';");
