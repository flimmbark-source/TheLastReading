...
// Reposition the three rummage props for the wide attic art. Percentages are relative to the full attic room.
...
html = html.replace("coat_01:{id:'coat_01',label:'Old Coat',verb:'Check pocket',motion:'search',cost:1,before:'props/old_coat_closed.png',after:'props/old_coat_searched.png',left:'17%',top:'30%',width:'39%',height:'44%',itemId:'letter_01',itemTitle:'Unsigned Letter',thumb:'handwritten_note.png'}", "coat_01:{id:'coat_01',label:'Old Coat',verb:'Check pocket',motion:'search',cost:1,before:'props/old_coat_closed.png',after:'props/old_coat_searched.png',left:'4%',top:'14%',width:'24%',height:'67%',itemId:'letter_01',itemTitle:'Unsigned Letter',thumb:'handwritten_note.png'}");
